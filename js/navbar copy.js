const nav_bar_change = () => {
	let items_list = document.getElementsByClassName(
		"dropdown-item menuFontStyle systemBtnMenu"
	);
    ...
    `;
	if (time_table)
		span.innerHTML += `<button class="btn btn-primary border-primary shadow-none" type="button" style="background: rgba(13,110,253,0);border-style: none;" onclick="document.getElementsByClassName('dropdown-item menuFontStyle systemBtnMenu')[${time_table}].click()" id="nav_short">Time Table</button>`;
	else
		span.innerHTML += `<button class="btn btn-primary border-primary shadow-none" type="button" style="background: rgba(13,110,253,0);border-style: none;" onclick="document.getElementsByClassName('dropdown-item menuFontStyle systemBtnMenu')[${calendar}].click()" id="nav_short">Calendar</button>`;
